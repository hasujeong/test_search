...
public class jobSearch implements QuerySetExtension {
	...
	public QuerySet makeQuerySet(RestHttpRequest request) {
		...
		SelectSet[] selectSets 		= CommonUtil.getSelectSet(Collections.JOB);
		WhereSet[] whereSets 		= CommonUtil.getWhereSet(searchVo, Collections.JOB);		// 검색조건     
    	OrderBySet[] orderBySets 	= CommonUtil.getOrderBySet(searchVo, Collections.JOB);	// 정렬조건      
		...
		System.out.println("JOB_query :::: " + queryStr);
